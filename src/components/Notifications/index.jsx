...
const Notifications = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-6 mt-16">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          {unreadCount > 0 && (
            <button 
              ...
              className="px-4 py-2 text-xs uppercase tracking-wider border border-white/30 rounded-full hover:border-white/70 hover:bg-white/5 transition-all"
            >
              mark all as read
            </button>
          )}
        ...
        {/* Filters */}
        <div className="flex gap-2 border-b border-white/10 mb-6 overflow-x-auto pb-px">
          {filters.map((filter) => (
            <button
              key={filter}
              onClick={() => setActiveFilter(filter)}
              className={`px-4 py-2 text-xs uppercase tracking-wider transition-all duration-300 relative ${
                activeFilter === filter
                  ? 'text-white'
          ...
          {filteredNotifications.length > 0 ? (
            filteredNotifications.map((notification) => (
              <div
                ...
                className={`group flex items-start gap-4 p-4 rounded-2xl transition-all duration-300 cursor-pointer ${
                  !notification.read
            ...
            <div className="text-center py-20">
              ...
              <p className="text-white/60 text-sm">no {activeFilter !== 'all' ? activeFilter : ''} notifications yet</p>
