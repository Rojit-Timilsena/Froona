    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex h-[calc(100vh-120px)]">
          ...
          <div className={`${mobileView === 'list' ? 'flex' : 'hidden md:flex'} flex-col w-full md:w-80 lg:w-96 border-r border-white/10 bg-black/30`}>
            {/* Search Bar */}
          ...
          <div className={`${mobileView === 'chat' ? 'flex' : 'hidden md:flex'} flex-1 flex-col bg-black/20`}>
            {selectedChat ? (
              <>
                {/* Chat Header */}
