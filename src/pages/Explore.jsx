...
export const Explore = () => {
  ...
  const [gridView, setGridView] = useState('grid'); // 'grid' or 'rows'
  const [hoveredPost, setHoveredPost] = useState(null);

  // Sample explore content - pure UI, no logic
        ...
        <div className={
          ...
          {filteredContent.map((item) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-linear-to-t from-black/90 via-black/50 to-transparent transition-all duration-500 ${
