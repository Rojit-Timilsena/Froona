...
const ProfileDesktop = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Header with gradient background - 62% width, centered, rounded */}
      <div className="flex justify-center pt-30">
        <div className="w-[62%] bg-gradient-to-r from-white/5 via-white/10 to-white/5 rounded-3xl pt-8 pb-20 md:pt-12 md:pb-24">
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
            ...
            <div className="flex flex-row items-end gap-8">
              ...
              <div className="relative">
                <div className="w-36 h-36 rounded-full bg-white/10 border-4 border-black flex items-center justify-center shadow-2xl">
                  <span className="text-5xl font-light">{user.avatar}</span>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        {/* Stats Row */}
        <div className="flex gap-8 py-4 border-b border-white/10 mt-4 mb-6">
              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  <div className={`absolute inset-0 bg-black/80 backdrop-blur-sm transition-all duration-500 flex items-center justify-center gap-6 ${
                    hoveredPost === post.id ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}>
